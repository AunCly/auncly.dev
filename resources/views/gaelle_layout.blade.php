...
<body class="bg-zinc-50 dark:bg-zinc-900">
	...
	<div class="my-10 w-full mx-auto lg:px-8 border-t-2 dark:border-t-0 border-zinc-50">
		<p class="mt-8 text-center text-base text-gray-400">Made with <i class="fa-solid fa-heart text-red-600"></i> and <i class="fa-light fa-code dark:text-zinc-50 text-gray-950"></i> by Gaëlle.</p>
	</div>
